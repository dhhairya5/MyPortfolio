...
import { FiGithub, FiTwitter, FiLinkedin, FiMail, FiMenu, FiX } from "react-icons/fi";
  ...
  return (
    <header className="absolute w-full z-50 transition-all duration-300">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
        ...
        <div className="md:flex hidden items-center space-x-5 ml-8">
          <motion.a
      ...
      >
        <nav className="flex flex-col space-y-3">
          {["Home", "About", "Projects", "Contact"].map((item) => (
              ...
              <button
                key={item}
                onClick={() => { toggleMenu(); navigate("/components/AboutSection"); }}
              ...
              <button
                key={item}
                onClick={() => { toggleMenu(); navigate("/components/ProjectSection"); }}
                className="text-gray-300 font-medium py-2 text-left"
              >
                {item}
              </button>
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="flex space-x-5">
            <a href="https://github.com/dhhairya5"><FiGithub className="h-5 w-5 text-gray-300" /></a>
            <a href="https://x.com/dhhairya_07"><FiTwitter className="h-5 w-5 text-gray-300" /></a>
            <a href="https://www.linkedin.com/in/dhhairya-shukla-58291a23b/"><FiLinkedin className="h-5 w-5 text-gray-300" /></a>
          </div>
